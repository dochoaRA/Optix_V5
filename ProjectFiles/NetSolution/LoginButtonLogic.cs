...
public class LoginButtonLogic : BaseNetLogic
{
    public override void Start()
    {
        ...
        {
            comboBox.Mode = ComboBoxMode.Editable; // Was normal in the original code, but changed to editable
        }
        else
        {
    ...
    public void PerformLogin(string username, string password)
    {
        ...
        try
        {
            ...
            {
                var dtLoginTimeStamp = DateTime.Now;
                LogicObject.GetVariable("LoginTimeStamp").Value = dtLoginTimeStamp;
            }
        }
        catch (Exception e)
        {
